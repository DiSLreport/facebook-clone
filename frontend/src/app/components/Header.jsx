        ...
        <nav className="hidden md:flex justify-around w-[40%] max-w-md">
          {[
            ...
            <Button
              ...
              size="icon"
              className={
                "relative text-gray-600 dark:text-gray-400 hover:text-blue-600 hover:bg-transparent"
              }
              ...
              <DropdownMenuLabel className="font-normal">
                <div className="flex flex-col space-y-1">
                  <div className="flex items-center">
                    <AvatarFacebook avatarClassNameSpesific="h-8 w-8 me-2" />
                    <div className="">
                      <p className="text-sm font-medium leadin-none">
                        {" "}
                        Generic Name
                      </p>
                      <p className="text-xs mt-2 text-gray-600 leadin-none">
                        {" "}
                        Email@ of user.com
                      </p>
                    </div>
