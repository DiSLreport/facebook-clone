            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-10">
                <div className="flex flex-col md:flex-row items-center md:items-end md:space-x-5">
                    ...
                    <div className="mt-4 md:mt-0 text-center md:text-left flex-grow">
                        <h1 className="text-3xl front-bold">Generic name</h1>
                        <p className="text-gray-400 font-semibold">3 friends</p>
                    </div>
                    <Button className="mt-4 md:mt-0" onClick={() => setIsEditProfileModel(true)}>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="flex justify-between items-center mb-4">
                                ...
                                <Button variant="ghost" size="icon" onClick={() => setIsEditProfileModel(false)}>
                                    <X className="w-4 h-4" />
                                </Button>
                            </div>
                            <form className="space-y-4">
                                ...
                                <Button type="submit" className="bg-blue-600 hover:bg-blue-400 text-white flex items-center gap-2">
